...
public interface ProductDAO extends JpaRepository<Product, Long> {
    ...
    // Lấy sản phẩm bán chạy nhất từ mỗi danh mục dựa trên số lượng đã bán thực tế
    @Query(value = "SELECT p.* FROM products p " +
            "JOIN ( " +
            "    SELECT p2.product_Category_Id, p2.id as product_id, " +
            ...
            "WHERE sales.rn = 1", nativeQuery = true)
    ...
    // Lấy top 10 sản phẩm bán chạy nhất theo tên product category (UNIFIED METHOD)
