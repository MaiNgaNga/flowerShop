...
public class WardController {
    ...
    @Autowired
    private ZoneService zoneService; // Để load danh sách zone cho dropdown

    // Load danh sách zone cho dropdown nếu form cần chọn zone
    ...
    public String index(Model model,
        ...
        if (keyword != null && !keyword.isEmpty()) {
            wardPage = wardService.searchByName(keyword, pageable);
    ...
    public String create(Model model,
        ...
        try {
            ...
            return "redirect:/Ward/index?tab=list";
    ...
    public String update(Model model,
        ...
        try {
            ...
            return "redirect:/Ward/edit/" + ward.getId() + "?tab=" + tab;
