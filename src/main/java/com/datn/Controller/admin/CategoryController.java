...
// @PostMapping("/create")
// public String create(Model model, @Valid @ModelAttribute("category") Category
// category,
...
// public String update(Model model,@Valid @ModelAttribute("category") Category
// category,
// Errors errors, RedirectAttributes redirectAttributes) {

// try {
// categoryService.update(category);
// redirectAttributes.addFlashAttribute("success", "Cập nhật loại hoa thành
// công!");
...
// public String delete(Model model, @ModelAttribute("category") Category
// category,
