...
// @ManyToOne
// @JoinColumn(name = "product_Category_Id", referencedColumnName = "id") // Tạo
// FK
...
// @AssertTrue(message = "Ngày kết thúc giảm giá phải là hôm nay hoặc tương
// lai")
// public boolean isDiscountEndValid() {
// return discountEnd == null || discountEnd.isEqual(LocalDate.now()) ||
// discountEnd.isAfter(LocalDate.now());
// }

// // Kiểm tra ngày bắt đầu giảm giá phải trước hoặc bằng ngày kết thúc
// @AssertTrue(message = "Ngày bắt đầu giảm giá phải trước hoặc bằng ngày kết
// thúc")
// public boolean isDiscountDateValid() {
// if (discountPercent != null && discountPercent > 0) {
// return discountStart != null && discountEnd != null &&
